...
export default function VentosScreen({ navigation }) {
  return (
    <ImageBackground
    source={require('../../../assets/images/tela_ilhaVento.png')}
      style={styles.fundo}
    >
      ...
      <Text style={styles.titulo}>ILHA DOS VENTOS</Text>

      <TouchableOpacity style={styles.fase} onPress={() => navigation.navigate('VentosFase1')}>
        <Text style={styles.faseTexto}>1 — Árvore dos Pensamentos</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.fase} onPress={() => navigation.navigate('VentosFase2')}>
        <Text style={styles.faseTexto}>2 — Ventos da Sabedoria</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.fase} onPress={() => navigation.navigate('VentosFase3')}>
        <Text style={styles.faseTexto}>3 — Indo Contra a Ventania</Text>
      </TouchableOpacity>
    </ImageBackground>
  );
}
